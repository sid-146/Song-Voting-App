      ...
      <div className="bg-spotify-gray-dark p-8 rounded-lg w-full max-w-md">
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-spotify-gray-light text-sm" htmlFor="remember-me">
              Remember me
            </label>
          </div>
          ...
          <div className="text-center space-y-4">
            <a href="#" className="text-spotify-gray-light hover:text-spotify-green text-sm">
              Forgot your password?
            </a>
            <div className="text-spotify-gray-light">
              Don't have an account?{' '}
              <a href="#" className="text-spotify-white font-bold hover:text-spotify-green">
                Sign up for Spotify
              </a>
            </div>
          </div>
